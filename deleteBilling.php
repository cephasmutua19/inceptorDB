...
<div class="container">
    ...
    $sql = "delete from invoice where bill_id = '$billId'";

    if ($conn->query($sql) == true) {
        print "<p>Bill/Invoice Deleted Successfully</p>";
        print "<a href='searchBillingD.php' class='btn btn-outline-danger'>Delete another Bill/Invoice</a>";
    } else {
        print "<p>Enquiry Not Deleted</p>";
        print "<a href='searchBillingD.php' class='btn btn-danger'>Try Again</a>";
    }
    mysqli_close($conn)
    ?>
</div>

...
if ($result->num_rows > 0) // If the table courses has data
{
    while ($row = $result->fetch_assoc()) {
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <form action="deleteAdmissions.php" method="POST">
                        <table class="table table-striped table-responsive-sm">
                            ...
                            <tr>
                                <td class="text-center" colspan="2">
                                    ...
                                    &nbsp; &nbsp;
                                    <a href="admissions.php" class="btn btn-secondary">Cancel Delete</a>
                                </td>
                            </tr>
                        </table>
                    </form>
    ...
    echo"Not Available in Database"."<br>".("<a href='searchAdmissionsD.php' class='btn btn-info'>Go Back</a>");
}
mysqli_close($conn);
?>
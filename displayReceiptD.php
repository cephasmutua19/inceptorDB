...
$rNum = mysqli_real_escape_string($conn, $_POST['rNumU']);

$sql = "SELECT * FROM receipt WHERE receipt_num='$rNum'";
...
if ($result->num_rows > 0) // If the table courses has data
{
                    ...
                    <form action="deleteReceipt.php" method="POST">
                        <table class="table table-striped table-responsive-sm">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="rNum" class="form-control" value="<?php echo $row['receipt_num']?>" required>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-right">
                                ...
                                <td>
                                    <input type="date" name="rDate" class="form-control" value="<?php echo $row['receipt_date']?>" required>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="paid" class="form-control" value="<?php echo $row['paid']?>" required>
                                </td>
                            </tr>
                            <tr>
                                <td class="text-center" colspan="2">
                                    ...
                                    &nbsp; &nbsp;
                                    <a href="receipt.php" class="btn btn-secondary">Cancel Delete</a>
                                </td>
                            </tr>
                        </table>
                    </form>
    ...
    echo"Not Available in Database"."<br>".("<a href='searchReceiptD.php' class='btn btn-info'>Go Back</a>");
}
mysqli_close($conn);
?>

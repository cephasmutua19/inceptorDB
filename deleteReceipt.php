...
<br>
<div class="heading">
    <h2 class="text-center text-white">Delete Receipt Success</h2>
</div>
<br>
<div class="container">
    <?php
    ...
    $sql = "delete from receipt where receipt_num ='$rNumber'";

    if ($conn->query($sql) == true) {
        print "<p>Receipt Deleted Successfully</p>";
        print "<a href='searchReceiptD.php' class='btn btn-primary'>Delete Receipt</a>";
    }
    else {
        print "<p>Receipt Not Deleted</p>";

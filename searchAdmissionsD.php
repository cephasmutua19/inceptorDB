...
<br>
<div class="heading">
    <h2 class="text-center text-white">Enter Admission Number to Delete</h2>
</div>
<br>
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-6">
            <form action="displayAdmissionsD.php" method="POST">
                <table class="table table-striped table-responsive-sm">
                    <tr>
                        ...
                        <td>
                            <input type="text" name="admission_numberU" class="form-control" required>
                        </td>
                    </tr>
                    <tr>
